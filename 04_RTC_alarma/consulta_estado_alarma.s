...
.equ MSK_ALARM, 0x0000000*                 @ Máscara del bit ALARM en RTC_SR      [*?*]
...
noalr:
  ...
  ldr    r0, [r7, #RTC_**]     @ r0 <- RTC Status Register                         [*?*]
  mov    r1, #MSK_*****        @ r1 <- máscara del bit ALARM en RTC_SR             [*?*]
  ...
  ***    *****                 @ Si no se ha activado la alarma, vuelve a 'noalr'  [*?*]
  ...
  str    r1, [r7, #RTC_****]   @ Pone a 0 el bit ALARM de RTC_SR                   [*?*]
